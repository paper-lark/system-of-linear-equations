...
release: ${SRC_DIR}/main.c ${SRC_DIR}/functions.c ${SRC_DIR}/iteration.c ${SRC_DIR}/gauss.c
	gcc ${RELEASE_FLAGS} ${SRC_DIR}/main.c ${SRC_DIR}/functions.c ${SRC_DIR}/iteration.c ${SRC_DIR}/gauss.c

debug: ${SRC_DIR}/main.c ${SRC_DIR}/functions.c ${SRC_DIR}/iteration.c ${SRC_DIR}/gauss.c
	gcc ${DEBUG_FLAGS} ${SRC_DIR}/main.c ${SRC_DIR}/functions.c ${SRC_DIR}/iteration.c ${SRC_DIR}/gauss.c
